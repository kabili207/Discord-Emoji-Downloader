      ...
      module = {
        ...
        get: {
          ...
          validation: function ($field) {
            let fieldValidation, identifier
            if (!validation) {
              return false
            }
            $.each(validation, function (fieldName, field) {
        ...
        closeOthers: function (index) {
          const $activeTitle =
              index !== undefined
                ? $title.eq(index)
                : $(this).closest(selector.title)
          const $parentTitles = $activeTitle
      ...
      module = {
        ...
        set: {
          opacity: function (opacity) {
            ...
            const isRGBA = colorArray && colorArray.length == 4
      ...
      module = {
        ...
        create: {
          ...
          userChoice: function (values) {
            let $userChoices, $userChoice, isUserValue, html
        ...
        select: {
          ...
          nextAvailable: function ($selected) {
            ...
            const $nextAvailable = $selected
              .nextAll(selector.item)
              .not(selector.unselectable)
              .eq(0)
            const $prevAvailable = $selected
        ...
        filter: function (query) {
          const searchTerm = query !== undefined ? query : module.get.query()
        ...
        queryRemote: function (query, callback) {
          let apiSettings = {
            ...
            onSuccess: function (response) {
              ...
              const hasRemoteValues = $.isArray(values) && values.length > 0
              if (hasRemoteValues) {
                module.remove.message()
                module.setup.menu({
        ...
        filterItems: function (query) {
          ...
          const beginsWithRegExp = new RegExp('^' + escapedTerm, 'igm')
        ...
        event: {
          ...
          keydown: function (event) {
            ...
            if (isShortcutKey) {
              ...
              const delimiterPressed =
                  pressedKey == keys.delimiter &&
                  settings.allowAdditions &&
                  module.is.multiple()
              const isAdditionWithoutMenu =
                  settings.allowAdditions &&
        ...
        determine: {
          ...
          eventOnElement: function (event, callback) {
            ...
            const notOnLabel = $module.find($label).length === 0
          ...
          item: function (value, strict) {
            ...
            if (shouldSearch) {
              $item.each(function () {
                ...
                const optionValue = module.get.choiceValue($choice, optionText)
                // safe early exit
        ...
        scrollPage: function (direction, $selectedItem) {
          ...
          const maxScroll = $menu.prop('scrollHeight')
          const newScroll =
              direction == 'up'
        ...
        set: {
          filtered: function () {
            ...
            const searchValue = isSearch ? module.get.query() : ''
          ...
          selectedItem: function ($item) {
            ...
            const text = module.get.choiceText($item, true)
          ...
          value: function (value, text, $selected) {
            const escapedValue = module.escape.value(value)
            const hasInput = $input.length > 0
            const currentValue = module.get.values()
            const stringValue = value !== undefined ? String(value) : value
            let newValue
            if (hasInput) {
          ...
          selected: function (value, $selectedItem) {
            ...
            $selectedItem.each(function () {
              ...
              const shouldAnimate = isMultiple && $selectedItem.length == 1
              if (isMultiple) {
        ...
        add: {
          label: function (value, text, shouldAnimate) {
            const $next = module.is.searchSelection() ? $search : $text
        ...
        remove: {
          ...
          label: function (value, shouldAnimate) {
            const $labels = $module.find(selector.label)
            const $removedLabel = $labels.filter(
              '[data-' +
                  metadata.value +
                  '="' +
        ...
        animate: {
          ...
          hide: function (callback, $subMenu) {
            const $currentMenu = $subMenu || $menu
            const duration = $subMenu ? settings.duration * 0.9 : settings.duration
            const start = $subMenu
              ? function () {}
              : function () {
                if (module.can.click()) {
            ...
            const transition = module.get.transition($subMenu)
            callback = $.isFunction(callback) ? callback : function () {}
            if (
        ...
        escape: {
          value: function (value) {
            ...
            const isUnparsable = !stringValue && !multipleValues
            const hasQuotes = stringValue && value.search(regExp.quote) !== -1
            const values = []
  ...
  $.fn.modal = function (parameters) {
    ...
    $allModules.each(function () {
      ...
      module = {
        ...
        set: {
          autofocus: function () {
            const $inputs = $module.find('[tabindex], :input').filter(':visible')
          ...
          modalOffset: function () {
            const width = module.cache.width
            const height = module.cache.height
            $module.css({
              marginTop:
...
(function ($, window, document, undefined) {
  ...
  $.fn.nag = function (parameters) {
    ...
    $allModules.each(function () {
      ...
      const $module = $(this)
      const $close = $module.find(selector.close)
      const $context = settings.context ? $(settings.context) : $('body')
      const element = this
...
(function ($, window, document, undefined) {
  ...
  $.fn.popup = function (parameters) {
    ...
    $allModules.each(function () {
      ...
      const $target = settings.target ? $(settings.target) : $module
      let $popup
      let $offsetParent
      let searchDepth = 0
      ...
      module = {
        ...
        create: function () {
          ...
          const content = module.get.content()
        ...
        get: {
          ...
          calculations: function () {
            ...
            const isWindow = $boundary[0] == window
            const targetPosition =
                settings.inline || (settings.popup && settings.movePopup)
                  ? $target.position()
                  : $target.offset()
            const screenPosition = isWindow
              ? { top: 0, left: 0 }
              : $boundary.offset()
            let calculations = {}
          ...
          offsetParent: function ($element) {
            const element = $element !== undefined ? $element[0] : $target[0]
    ...
    $allModules.each(function () {
      ...
      module = {
        ...
        increment: function (incrementValue) {
          let maxValue, startValue, newValue
          if (module.has.total()) {
        ...
        get: {
          text: function (templateText) {
            const value = module.value || 0
            const total = module.total || 0
            const percent = animating
              ? module.get.displayPercent()
              : module.percent || 0
            const left = module.total > 0 ? total - value : 100 - percent
        ...
        event: {
          ...
          result: {
            ...
            click: function (event) {
              ...
              const value = $title.length > 0 ? $title.text() : false
        ...
        search: {
          ...
          object: function (searchTerm, source, searchFields) {
            ...
            const addResult = function (array, result) {
              const notResult = $.inArray(result, results) == -1
...
(function ($, window, document, undefined) {
  ...
  $.fn.shape = function (parameters) {
    ...
    $allModules.each(function () {
      ...
      let $side = $module.find(selector.side)
      // private variables
      let nextIndex = false
      let $activeSide
      let $nextSide
      ...
      module = {
        ...
        set: {
          ...
          currentStageSize: function () {
            const $activeSide = $module.find('.' + settings.className.active)
          ...
          stageSize: function () {
            ...
            const $activeSide = $clone.find('.' + settings.className.active)
      ...
      module = {
        ...
        is: {
          ...
          ios: function () {
            ...
            const isIOS = userAgent.match(regExp.ios)
            const isMobileChrome = userAgent.match(regExp.mobileChrome)
...
(function ($, window, document, undefined) {
  ...
  $.fn.sticky = function (parameters) {
    ...
    $allModules.each(function () {
      ...
      const $module = $(this)
      const $window = $(window)
      const $scroll = $(settings.scrollContext)
      let $container
      let $context
      ...
      module = {
        ...
        stick: function (scroll) {
          const cachedPosition = scroll || $scroll.scrollTop()
          ...
          const direction = module.get.direction(scroll.top)
          const elementScroll = fits ? 0 : module.get.elementScroll(scroll.top)
          // shorthand
...
(function ($, window, document, undefined) {
  ...
  $.fn.tab = function (parameters) {
    const // use window context if none specified
      ...
      module = {
        ...
        get: {
          ...
          tabElement: function (tabPath) {
            let $fullPathTab, $simplePathTab, tabPathArray, lastTab
            tabPath = tabPath || activeTabPath
      ...
      module = {
        ...
        get: {
          ...
          animationClass: function (animation) {
            const animationClass = animation || settings.animation
...
(function ($, window, document, undefined) {
  ...
  $.api = $.fn.api = function (parameters) {
    ...
    $allModules.each(function () {
      ...
      const $context = settings.stateContext ? $(settings.stateContext) : $module
      // request details
      let ajaxSettings
      let requestSettings
      let url
      ...
      module = {
        ...
        add: {
          urlData: function (url, urlData) {
            let requiredVariables, optionalVariables
            if (url) {
          ...
          formData: function (data) {
            const canSerialize = $.fn.serializeObject !== undefined
        ...
        event: {
          ...
          request: {
            ...
            fail: function (xhr, status, httpMessage) {
              const // pull response from xhr if available
                response = module.get.responseFromXHR(xhr)
              const errorMessage = module.get.errorFromRequest(
                response,
                status,
                httpMessage
              )
        ...
        create: {
          ...
          mockedXHR: function () {
            const // xhr does not simulate these properties of xhr but must return them
              textStatus = false
            const status = false

  ...
  $.fn.video = function (parameters) {
    ...
    $allModules.each(function () {
      ...
      module = {
        ...
        create: function () {
          const image = $module.data(metadata.image)
        ...
        play: function () {
          ...
          const source = $module.data(metadata.source) || false
        ...
        generate: {
          ...
          url: function (source) {
            const api = settings.api ? 1 : 0
            const autoplay =
                settings.autoplay === 'auto'
                  ? $module.data('image') !== undefined
                  : settings.autoplay
            const hd = settings.hd ? 1 : 0
            const showUI = settings.showUI ? 1 : 0
            // opposite used for some params
            const hideUI = !settings.showUI ? 1 : 0
            let url = ''
            if (source == 'vimeo') {
              url =
                '' +

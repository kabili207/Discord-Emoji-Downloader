...
(function ($, window, document, undefined) {
  ...
  $.visit = $.fn.visit = function (parameters) {
    const $allModules = $.isFunction(this) ? $(window) : $(this)
    ...
    $allModules.each(function () {
      ...
      module = {
        ...
        increment: function (id) {
          const currentValue = module.get.count()
        ...
        add: {
          id: function (id) {
            const currentIDs = module.retrieve(settings.key.ids)
            const newIDs =
        ...
        remove: {
          id: function (id) {
            const currentIDs = module.get.ids()
            let newIDs = []
        ...
        store: function (key, value) {
          const options = module.get.storageOptions(value)
          if (
